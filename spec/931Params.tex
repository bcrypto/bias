...
небольшим.
%
Рекомендуемый срок: не более 10~\addendum{мин}.
...
\item
\lstinline{"wap"}~---
интерфейс \addendum{сотового} телефона (не смартфона).
\end{itemize}
...
%
Например, значение 300 означает, что БД действует в течение \addendum{5~мин} с 
